...
set vs_app_dir=%bat_dir%\build\windows\vs2015\apps\ffmpeg_wrapper_mfc_app
cmake -S "%bat_dir%\apps\ffmpeg_wrapper_app\windows\FfmpegWrapperMfcApp" -B "%vs_app_dir%" -G "Visual Studio 14 2015" -A Win32 -T v140 -DWINDOWS:BOOL=ON
