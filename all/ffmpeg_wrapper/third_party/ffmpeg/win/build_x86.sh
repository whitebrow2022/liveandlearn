...
x264_install_dir=${bash_dir}/../../x264/out/win_x86
export PKG_CONFIG_PATH=${PKG_CONFIG_PATH}:${x264_install_dir}/lib/pkgconfig
# 
ffmpeg_install_dir=${bash_dir}/../out/win_x86

./configure --toolchain=msvc --target-os=win64 --arch=x86_64 --enable-static --disable-shared --prefix=${ffmpeg_install_dir} --disable-programs --enable-libx264 --enable-gpl
make
make install

# 5.重命名静态库后缀名
cd ${ffmpeg_install_dir}/lib
