@cls
@title Generate 'Visual Studio 16 2019' solution for FfmpegWrapper mfc app
@echo off
...
set vs_app_dir=%bat_dir%\build\windows\vs2019\apps\ffmpeg_wrapper_app
cmake -S "%bat_dir%\apps\ffmpeg_wrapper_app\windows\ffmpeg_wrapper_app" -B "%vs_app_dir%" -G "Visual Studio 16 2019" -A Win32 -T v142 -DWINDOWS:BOOL=ON
