...
FfmpegWrapperPopWindow::FfmpegWrapperPopWindow() {}
FfmpegWrapperPopWindow::~FfmpegWrapperPopWindow() {}

LRESULT FfmpegWrapperPopWindow::HandleMessage(UINT msg, WPARAM w_param,
                                              LPARAM l_param) {
  switch (msg) {
    case WM_CREATE: {
    ...
    case WM_PAINT: {
      ...
      TCHAR text[] = TEXT("FfmpegWrapperPopWindow");
      RECT client_area;
