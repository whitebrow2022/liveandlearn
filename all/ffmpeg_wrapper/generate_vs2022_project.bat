@cls
@title Generate 'Visual Studio 17 2022' solution for FfmpegWrapper
@echo off
...
set vs_example_dir=%bat_dir%\build\windows\vs2022\examples\ffmpeg_wrapper_example
cmake -S "%bat_dir%\examples\ffmpeg_wrapper_example" -B "%vs_example_dir%" -G "Visual Studio 17 2022" -A Win32 -T v143 -DWINDOWS:BOOL=ON
