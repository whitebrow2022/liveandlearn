@cls
@title Generate 'Visual Studio 16 2019' solution for FfmpegWrapper
@echo off
...
set vs_example_dir=%bat_dir%\build\windows\vs2019\examples\ffmpeg_wrapper_example
cmake -S "%bat_dir%\examples\ffmpeg_wrapper_example" -B "%vs_example_dir%" -G "Visual Studio 16 2019" -A Win32 -T v142 -DWINDOWS:BOOL=ON
