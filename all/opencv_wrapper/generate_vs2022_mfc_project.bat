...
set vs_app_dir=%bat_dir%\build\windows\vs2022\apps\opencv_wrapper_mfc_app
cmake -S "%bat_dir%\apps\opencv_wrapper_app\windows\OpencvWrapperMfcApp" -B "%vs_app_dir%" -G "Visual Studio 17 2022" -A Win32 -T v143 -DWINDOWS:BOOL=ON
...
if exist %vs_mfc_app_sln% (
  ...
  mklink "%vs_mfc_app_sln%" "%vs_app_dir%\opencv_wrapper_mfc_app.sln"
)
